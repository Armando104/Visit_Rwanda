    ...
    <center>
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 36px #000;-moz-box-shadow:0 0 36px #000;-webkit-box-shadow:0 0 6px #000;">
            ...
            <div style="width: 960px;height: 400px;overflow-x:  scroll;background-color: white;color:black;border-bottom: 4px solid #99FF00">
                ...
                <center>  ${in.msg} 
                    <h3>Your Services Request(s)</h3>
                    <table border="1" class="" id="" style="width: 1200px">
                        <thead>
                            <tr>
                                <td style="background-color: #3d3d3d;color: white">No</td>
                                <td style="background-color: #3d3d3d;color: white">Submitted On</td>
                                <td style="background-color: #3d3d3d;color: white">Request Date</td>
                        ...
                        <tbody>
                            <%
                                ...
                                for (int i = 0; i < l.size(); i++) {
                                    ...
                                    if(l.get(i).getVisit_id()==vs.getCitizen_id()){
                                    Instutition in = Instutition.getInstutitionFromID(sr.getEntity_id() + "");
                            %>
                            <tr>
                                <td><%=no%></td>
                                <td><%=l.get(i).getSending_date()%></td> 
                                ...
                                <%
                                        if(l.get(i).getRequest_status().equalsIgnoreCase("paid")){
                                         %>
                                         <td>
                                        ...
                                        %>
                                         <td>
                                             <button class="btn btn-inverse">
                                                 <a style="color: white;" target="_blank" href="Payment/paypalpay.jsp?xo=<%=l.get(i).getRequest_id() %>">Pay Now</a>
