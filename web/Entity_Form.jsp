        ...
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 36px #000;-moz-box-shadow:0 0 36px #000;-webkit-box-shadow:0 0 6px #000;">
            ...
            <div style="width: 960px;height: auto;background-color: #00513a;color:white;border-bottom: 4px solid #99FF00">
                ...
                <center> 
                    ...
                    ${c.msg} 
                    <form action="Entity_Registration_Processing.jsp" method="GET">
                        <table border="0">

                            <tbody>
                                <tr>
                                    <td></td>
                                    <td><h3 style="color: white">New Entity Registration Form</h3></td>
                                    <td style="color: red;"></td>
                                </tr>
                                <tr>
                                    <td>Entity Domain</td>
                                    <td><select name="domain_v">
                                            <%
                                                List<Domain>l=Domain.getList();
                                                for(int i=0;i<l.size();i++){
                                                %>
                                                <option><%=l.get(i).getName() %></option>
                                            <%
                                                }   %>
                                        </select></td>
                                    <td style="color: red;"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="accronym" value="${c.accronym}" required=""/></td>
                                    <td style="color: red;"></td>
                                </tr>
                                
                                <tr>
                                    <td>Who are You?</td>
                                    <td><textarea name="details" rows="4" cols="20" style="width: 450px;">
                                        </textarea></td>
                                    <td style="color: red;"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Bank-Account</td>
                                    <td><input type="text" name="acct_no" value="${c.acct_no}" required=""/></td>
                                    <td style="color: red;"></td>
                                </tr>
