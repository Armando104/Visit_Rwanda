        ...
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 36px #000;-moz-box-shadow:0 0 36px #000;-webkit-box-shadow:0 0 6px #000;">
            ...
            <div style="width: 960px;height: 400px;overflow-y:  scroll;background-color: white;color:black;border-bottom: 4px solid #99FF00">
                ...
                <center>  ${c.msg} 
                    ...
                    <h2><a style="text-decoration: none">Select a Domain to be visited</a></h2>
                         <table border="1" class="table table-striped" id="sample_11" style="width: 1500px">
                        <thead>
                             <tr>
                         ...
                         <tbody>
                             <%
                                 ...
                                 %>
                             <tr>
                                 <td><a style="text-decoration: none"><%=no %></a></td>
                                 
                                 <td><a href="Entities_List_Visitor.jsp?x=<%=l.get(i).getDomain_id()%>"><%=l.get(i).getName()  %></a></td>
                                 </tr>
                                 <% 
  no++;                                 
}%>
