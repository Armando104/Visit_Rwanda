...
<%
	...
	*/
	...
	String paymentAmount = "2";//(String) session.getAttribute("Payment_Amount");
 session.setAttribute("Payment_Amount", "2");
	/*
	'------------------------------------
	...
	*/
	...
	String returnURL = "http://localhost:8084/VisitRwanda2015/Payment/payment.jsp";
	...
	'------------------------------------
	*/
	String cancelURL = "http://localhost:8084/VisitRwanda2015/Request_List.jsp";
