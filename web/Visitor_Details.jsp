    ...
    <center>
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 36px #000;-moz-box-shadow:0 0 36px #000;-webkit-box-shadow:0 0 6px #000;">
            ...
            <div style="width: 960px;height: 400px;overflow-y:  scroll;background-color: white;color:black;border-bottom: 4px solid #99FF00">
                ...
                <center>  ${in.msg} 
                    <b> <h3><a href="#">Registered Visitors</a></h3></b>
                    ...
                    <table border="1" class="table table-striped" id="sample_1" style="">
                        <thead>
                            <tr>
                                ...
                                <td style="background-color: #3d3d3d;color: white">Address</td>
                                <td style="background-color: #3d3d3d;color: white">Email</td>
                                <td style="background-color: #3d3d3d;color: white">Tel</td>
                                <td style="background-color: #3d3d3d;color: white">Profession</td>
                                <td style="background-color: #3d3d3d;color: white">Nationality</td>
                            </tr>
                        </thead>
                        <tbody>
                            <%
                                List<Visitor> l = Visitor.getList();
                                int no = 1;
                                for (int i = 0; i < l.size(); i++) {
                                    if(l.get(i).getUser_id()==Integer.parseInt(request.getParameter("ix"))){
                            %>
                            <tr>
                                <td><%=no%></td>
                                ...
                                <td><%=l.get(i).getOccupation()%></td>
                                <td><%=l.get(i).getNationality()%></td>
                            </tr>
                            <%
                                    no++;
                                    }
