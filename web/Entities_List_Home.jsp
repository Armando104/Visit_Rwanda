...
<html>
    ...
    <center>
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 50px #000;-moz-box-shadow:0 50px 50px #000;-webkit-box-shadow:0 0 50px #000;">
            ...
            <div style="width: 960px;height: 700px;overflow:  scroll;background-color: white;color:black;border-bottom: 4px solid #99FF00">

                <center>  ${in.msg} 
                    
                        <h3>   <a style="text-decoration: none">All Registered Entities</a></h3>
                             ...
                             <%
                                 ...
                                 for(int i=0;i<l.size();i++){
                                   {
                                 %>
                                 <div style="width: 300px;height: 600px;overflow-y: scroll;float: right;border: 2px solid #002118;margin: 3px;">
                                     <%
                                      if(l.get(i).getLogo()==null){
                                      %>
                                     
                                      <div style="width: 100%;height: 145px;background-color: whitesmoke">
                                          
                                     
                                      <img src="Files/profile.png" width="255" height="145" alt="profile" style="width: 185px;height: 130px;border-radius: 5px;border:4px solid #000;margin-top: 2px;"/>
                                       </div>
                                      <%
                                      }else{
                                      %>
                                       
                                       <div style="width: 100%;height: 145px;background-color: white;border-bottom: 2px solid black">
                                       
                                      <img src="Files/<%=l.get(i).getLogo() %>" width="255" height="145" alt="profile" style="width: 185px;height: 130px;border-radius: 5px;border:4px solid #000;margin-top: 2px;"/>
                                       </div>
                                      <%
                                      }   
                                      %>
                                      <h3><a style="text-decoration: none"><%="Name:"+l.get(i).getName() %></a></h3>
                                      <h3><a style="text-decoration: none"><%="Acronym:"+l.get(i).getAccronym()%></a></h3>
                                      
                                        <h3><a style="text-decoration: none;color: #3d3d3d"><%=""+l.get(i).getDetails()%></a></h3>
                                        
                                      <h3><a style="text-decoration: none"><%="Address:"+l.get(i).getAddress()%></a></h3>
                                        <h3><a style="text-decoration: none"><%="Tel:"+l.get(i).getTel()%></a></h3>
                                          <h3><a style="text-decoration: none"><%=""+l.get(i).getEmail()%></a></h3>
                                          <h3><a style="color: #000" href="Service_List_Visitor.jsp?id=<%=""+l.get(i).getInstutition_id()%>">We <%=" Deliver ("+Service.getCount_Services_Per_Entity(l.get(i).getInstutition_id()+"")+") Service(s)" %></a></a></h3>
