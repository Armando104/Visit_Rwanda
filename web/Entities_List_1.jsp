            ...
            <div style="width: 960px;height: 400px;overflow-y:  scroll;background-color: white;color:black;border-bottom: 4px solid #99FF00">
                ...
                <center>  ${in.msg} 
                    <%
                        ...
                        %>
                        <h3>Registered Entities in <%=" "+in.getName()+" Domain" %></h3>
                        ...
                        <thead>
                             <tr>
                                 <td style="background-color: #3d3d3d;color: white">No</td>
                                  <td style="background-color: #3d3d3d;color: white">Entity Name</td>
                                  <td style="background-color: #3d3d3d;color: white">Acronym</td>
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td><a href="Service_List_Admin.jsp?id=<%=l.get(i).getInstutition_id()%>"><%=l.get(i).getName()%></a></td>
                                 <td><%=l.get(i).getAccronym()%></td>
                                 <td><a target="_blank" href="Details.jsp?id=<%=l.get(i).getInstutition_id()%>">View</a></td>
                             </tr>
                                 <% 
  no++;  }                               
}%>
