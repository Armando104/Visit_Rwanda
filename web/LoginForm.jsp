...
<html>
    ...
    <center>
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 36px #000;-moz-box-shadow:0 0 36px #000;-webkit-box-shadow:0 0 6px #000;">
            ...
            <div style="width: 960px;height: 400px;background-color: #00513a;color:white;border-bottom: 4px solid #99FF00">

                <center> <br>
                    
                    <br><br><br>
                    <h2 style="color: white">Please Provide Correct Username And Password</h2>
                 ${dd.msg}
                    ...
                    <table border="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="color: red">${dd.usernamemsg}</td>
                            </tr>
                            <tr>
                                <td>Password</td>
                                <td><input type="password" name="password" value="${dd.password}" /></td>
                                <td style="color: red">${dd.passwordmsg}</td>
                            ...
                            <tr>
                                ...
                                <h3>  <a href="Visitor_Form.jsp" style="color: white">New Visitor's Registration Form</a></h3>
                              </center>
            </div>
