...
<html>
    ...
    <center>
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 36px #000;-moz-box-shadow:0 0 36px #000;-webkit-box-shadow:0 0 6px #000;">
            ...
            <div style="width: 960px;height: 400px;overflow:  scroll;background-color: white;color:black;border-bottom: 4px solid #99FF00">

                <center>  ${in.msg} 
                    <%
                        Domain in=Domain.getDomainFromID(request.getParameter("x"));
                        %>
                        <h3>   <a style="text-decoration: none">Registered Entities in <%=" "+in.getName()+" Domain" %></a></h3>
                          
                             <%
                                 List<Instutition>l=Instutition.getList();
                                 int no=1;
                                 for(int i=0;i<l.size();i++){
                                     if(Integer.parseInt(request.getParameter("x"))==l.get(i).getDomain_id()){
                                 %>
                                 <div style="width: 300px;float: left;border: 2px solid #002118;margin: 3px;">
                                     <%
                                      if(l.get(i).getLogo()==null){
                                      %>
                                      <div style="width: 100%;height: 100%;background-color: #002118">
                                          
                                     
                                      <img src="Files/profile.png" width="255" height="145" alt="profile" style="width: 185px;height: 130px;"/>
                                       </div>
                                      <%
                                      }else{
                                      %>
                                       <div style="width: 100%;height: 100%;background-color: #002118;border-bottom: 2px solid black">
                                       
                                      <img src="Files/<%=l.get(i).getLogo() %>" width="255" height="145" alt="profile" style="width: 185px;height: 130px;"/>
                                       </div>
                                      <%
                                      }   
                                      %>
                                      ...
                                      <h3><a style="text-decoration: none"><%="Address:"+l.get(i).getAddress()%></a></h3>
                                        <h3><a style="text-decoration: none"><%="Tel:"+l.get(i).getTel()%></a></h3>
                                          ...
                                          <h3><a style="text-decoration: none"><a href="Service_List_Visitor.jsp?id=<%=""+l.get(i).getInstutition_id()%>">View Our  Delivered Services</a></a></h3>
