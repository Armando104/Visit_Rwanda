<h2 style="text-align: center; font-size: 20px; margin-left: 20px; color: #227293">
    <%    /*==================================================================
        ...
        // out.print("This is review");
        if (token != null) {
            //  out.print("The token is not null at review");
    %>
    ...
    <%
            ...
            out.print("The token is null at review");
        }
    %>
    ...
    <form action="confirmation.jsp">
        <input type="submit" value="Confirm" style="border-color: #00ff00; color: #227293; width: 80px;"/>
        <a href="../customer_homepage.jsp">
            <input type="button" value="Cancel" style="border-color: #00ff00; color: #227293; width: 80px;"/>
        </a>
    </form>
</h2>