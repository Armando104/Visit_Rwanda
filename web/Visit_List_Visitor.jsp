    ...
    <center>
        <div style="width: 960px;height: auto;background-color: white;border: 2px solid whitesmoke;box-shadow:0 0 36px #000;-moz-box-shadow:0 0 36px #000;-webkit-box-shadow:0 0 6px #000;">
            ...
            <div style="width: 960px;height: auto;background-color: white;">
                <jsp:include page="Visitor_Menus.html"/>
            </div>
            <div style="width: 960px;height: auto;background-color: white;">
            ...
            <div style="width: 960px;height: 400px;overflow-y:  scroll;background-color: white;color:black;border-bottom: 4px solid #99FF00">
                ...
                <center>  ${in.msg} 
                    <h3><a style="text-decoration: none"><%="" + v.getNames()+"'s Visit(s)"%></a></h3>
                    <table border="1" class="table table-striped" id="sample_1" style="width: 1500px">
                        <thead>
                            <tr>
                                ...
                                <td style="background-color: #3d3d3d;color: white">Date</td>
                                <td style="background-color: #3d3d3d;color: white">Visited Entity</td>
                                 
                            </tr>
                        </thead>
                        <tbody>
                            <%
                                List<Visit> l = Visit.getList();
                                int no = 1;
                                for (int i = 0; i < l.size(); i++) {
                                   
                                    Instutition sr = Instutition.getInstutitionFromID(l.get(i).getEntity_id()+ "");
                                     if(l.get(i).getVisitor_id()==v.getCitizen_id()){
